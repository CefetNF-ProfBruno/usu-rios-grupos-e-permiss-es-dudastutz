...
4)sudo chmod /srv/alunos 770 > ./questao4.sh
  sudo chmod /srv/professores 770 >> ./questao4.sh
  
5)sudo adduser bruno --home /srv/professores/bruno --ingroup professor > questao7.sh --gecos`` --disabled-login
...
6)sudo usermod bruno -a -G gerente > questao6.sh

7)sudo chmod 770 /srv/alunos > ./questao7.sh
  sudo chmod 770 /srv/professores >> ./questao7.sh

8)sudo usermod maria -e 2024-12-31 -f 90 > questao8.sh
